...
% CONTACT INFORMATION
%====================
\def\name{Marc Miller} % Name Here
\signature{\name}
\address{1234 Huckleberry Cv., \\
Apt. \#123 \\ 
Austin, Texas \\
78787}
\def\phone{(512) 638-7372}
\def\email{mill4223@purdue.edu}
\def\LinkedIn{marc-miller-a878632a8} % linkedin.com/in/______
\def\github{mamiller2007} % github username
\def\role{Sodtware Engineer} % JOB TITLE

%====================
% Company Info
%====================
\def\hm{Jane Doe} % Hiring Manager Name, leave empty if unknown
\def\position{Systems Software Engineer} % position
\def\company{HP IQ} % company
...
\begin{document}
\begin{letter}{\hm \\ Hiring Manager \\ \company \\ Address line 1 \\ Address line 2  }
